...
export const metadata: Metadata = {
  ...
  description: "Better Marque is a creative agency that crafts innovative brand identities and sleek websites for architects, builders, and realtors. We combine design precision with functionality to elevate your brand and business presence.",
};
