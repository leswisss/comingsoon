...
export const metadata: Metadata = {
  ...
  description:
    "Better Marque is a branding agency dedicated to helping architects, builders, and real estate agencies stand out in their industries. We create unique websites and brand identities that elevate their presence and help them close more clients",
  twitter: {
