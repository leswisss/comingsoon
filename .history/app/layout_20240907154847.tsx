...
export const metadata: Metadata = {
  ...
  description:
    "Better Marque is a distinguished creative agency dedicated to helping Architects, Builders, and Real Estate Agen stand out in their industries. We create unique websites and brand identities that elevate their presence and help them close more clients",
  twitter: {
