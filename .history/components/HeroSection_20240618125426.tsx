...
const HeroSection = ({imageLoaded, setImageLoaded}: {imageLoaded: boolean, setImageLoaded: React.Dispatch<React.SetStateAction<boolean>>}) => {
  const slogan =
  ...
  return (
    <section className={styles.hero}>
      <div className={styles.hero_image} ref={heroRef}>
        <Image src={IMAGE} fill quality={100} alt="Better Marque" onLoad={() => setImageLoaded(true)}/>
      </div>
