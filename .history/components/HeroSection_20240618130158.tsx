  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={styles.slogan_wrapper}>
        <div className={styles.s_wrap}><span className={styles.black}>© Embrace Uniqueness</span></div>
        <div className={styles.s_wrap}><span className={styles.white}>© Embrace Uniqueness</span></div>
      </div>
    </section>
  );
};
